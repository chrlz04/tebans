    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <CashierCollectionProgress progress={data?.collectionProgress} previousProgress={data?.previousCollectionProgress} isLoading={isLoading} currentPeriodLabel={data?.currentPeriodLabel} previousPeriodLabel={data?.previousPeriodLabel} />
        </div>

  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100 pb-6">
        <h2 className="text-xl font-semibold text-gray-900">My collection progress</h2>
        <DueDateBadge />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-[#f8f9f6] rounded-xl p-6 flex flex-col items-center justify-center">
          <p className="text-sm text-gray-600 mb-2">Not yet paid</p>
      ...
      {/* Not Yet Paid List */}
      <div>
        <h3 className="text-sm font-semibold text-gray-500 mb-4 tracking-wider uppercase">Consumers who haven't paid yet</h3>
            ...
            {progress.notYetPaidList.map((consumer) => (
              <div key={consumer.consumerId} className="flex justify-between items-center py-3 border-b border-gray-100 last:border-0">
                ...
                <div className="text-right">
                  ...
                  <span className="bg-[#fdf0e6] text-[#b83d1c] text-xs font-medium px-3 py-1.5 rounded-full whitespace-nowrap inline-block mt-1">
                    Unpaid
                  </span>
                </div>
              </div>

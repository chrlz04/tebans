    ...
    <div className="flex flex-col gap-6 max-w-3xl w-full mx-auto">
      ...
      <div>
        ...
        <p className="text-[13px] text-muted-foreground mt-0.5">
          Your cashier account information
        </p>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border overflow-hidden">
        ...
        <div className="bg-muted/40 border-b border-border px-7 pt-6 pb-0 flex items-end gap-5">
          ...
          {/* Avatar */}
          <div className="relative top-3.5 size-[58px] rounded-full bg-amber-50 dark:bg-amber-950 border-2 border-card flex items-center justify-center flex-shrink-0">
            <span className="font-mono text-[19px] font-medium text-amber-600 dark:text-amber-400 leading-none">
              {isLoading ? '·' : initials}
            </span>
          </div>
        ...
        <div className="grid grid-cols-2 divide-x divide-y divide-border border-t border-border">
          <Field label="Cashier ID"     value={profile?.cashierId}  mono isLoading={isLoading} />

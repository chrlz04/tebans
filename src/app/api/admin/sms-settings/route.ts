...
export async function GET(req: NextRequest) {
  try {
    ...
    const keys = [
      ...
      'SMS_BATCH_SENDING_ENABLED', 'SMS_BATCH_SIZE_LIMIT', 'SMS_BATCH_DELAY',
      'SMS_REQUIRE_CONFIRMATION', 'SMS_AUTO_MARK_SENT', 'SMS_MESSAGE_TEMPLATE',
      'SMS_LAST_TEST_DATE', 'SMS_LAST_TEST_STATUS'
    ]

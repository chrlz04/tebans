    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          <BillingCycleProgress progress={data?.billingProgress} previousProgress={data?.previousBillingProgress} isLoading={isLoading} />
          <PaymentCollectionProgress progress={data?.paymentProgress} previousProgress={data?.previousPaymentProgress} isLoading={isLoading} />
        </div>

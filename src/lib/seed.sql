...
INSERT INTO `user` (`User_ID`, `First_Name`, `Last_Name`, `Contact_No`, `User_Type`, `Account_Status`, `Registration_Date`, `Login_ID`) VALUES
  ...
  ('user-consumer-003', 'Pedro',   'Ramos',     '09571234567',  'consumer',     'Active', '2026-03-30 21:22:34', NULL),
  ...
  ('user-consumer-006', 'Charles', 'Carcallas', '09167928436w', 'consumer',     'Active', '2026-04-24 10:56:24', 'login-consumer-006'),
  ('user-mr-001',       'Juan',    'DelaCruz',  '09171234567',  'meter_reader', 'Active', '2026-04-01 21:22:34', 'login-mr-001'),
  ('user-mr-002',       'daryl',   'Valdez',    '22222',        'cashier',      'Active', '2026-04-07 12:13:15', 'login-mr-002'),
...
INSERT INTO `consumer` (`Consumer_ID`, `Address`, `Province`, `Municipality`, `Barangay`, `Area_ID`, `Meter_Serial_No`, `User_ID`) VALUES
  ('consumer-001', 'Purok 3, Tubod, Clarins, Bohol',   NULL,    NULL,     NULL,    'area-001', 'MSN-2024-0001',   'user-consumer-001'),
  ('consumer-002', 'Purok 5, Tubod, Clarin, Bohol',    NULL,    NULL,     NULL,    NULL,       'MSN-2024-0002',   'user-consumer-002'),
  ('consumer-003', 'Purok 1, Tubod, Clarin, Bohol',    NULL,    NULL,     NULL,    'area-002', 'MSN-2024-0003',   'user-consumer-003'),
  ('consumer-004', 'Purok 7, Tubod, Clarin, Bohol',    NULL,    NULL,     NULL,    'area-002', 'MSN-2024-0004',   'user-consumer-004'),
  ('consumer-005', 'Tubod, Clarin',                    NULL,    NULL,     NULL,    'area-001', '5437563485634',   'user-consumer-005'),
...
INSERT INTO `disconnectionrequest` (`DisconnectionRequest_ID`, `Consumer_ID`, `MeterReader_ID`, `Reason_for_Disconnection`, `Scheduled_Date`, `Request_Status`, `Date_Requested`) VALUES
  ('dreq-001', 'consumer-007', 'mr-001', 'Unpaid bill for two consecutive months.',          '2025-03-28', 'Executed', '2026-03-30 21:22:34'),
  ('dreq-002', 'consumer-008', 'mr-001', 'Account flagged as Inactive with no meter usage.', '2025-03-27', 'Executed', '2026-03-30 21:22:34');
...
INSERT INTO `notification` (`Notification_ID`, `Consumer_ID`, `MeterReading_ID`, `DisconnectionRequest_ID`, `Alert_Type`, `Message_Content`, `Date_Sent`, `Reference_Type`, `Status`) VALUES
  ('notif-001', 'consumer-001', 'mr-read-001', NULL,       'Billing',       'Your bill for March 2025 amounting to ₱1,856.75 is due on March 25, 2025.',                  '2026-03-30 21:22:34', 'MeterReading',        'Pending'),
  ('notif-002', 'consumer-002', 'mr-read-002', NULL,       'Billing',       'Your bill for March 2025 amounting to ₱1,598.40 is due on March 25, 2025.',                  '2026-03-30 21:22:34', 'MeterReading',        'Pending'),
  ('notif-003', 'consumer-007', NULL,           'dreq-001', 'Disconnection', 'A disconnection has been scheduled on March 28, 2025 due to unpaid bills.',                  '2026-03-30 21:22:34', 'DisconnectionRequest','Pending'),
  ('notif-004', 'consumer-008', NULL,           'dreq-002', 'Disconnection', 'Your account has been disconnected on March 27, 2025. Please contact the office.',           '2026-03-30 21:22:34', 'DisconnectionRequest','Pending');
